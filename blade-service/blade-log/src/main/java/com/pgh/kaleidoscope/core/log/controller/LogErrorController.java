...
import com.pgh.kaleidoscope.core.log.model.LogErrorVo;
...
public class LogErrorController {
	 ...
	 */
	@GetMapping("/detail")
	public CommonResult<LogError> detail(LogError logError) {
		return CommonResult.data(errorLogService.getOne(Condition.getQueryWrapper(logError)));
	}
	 ...
	 */
	@GetMapping("/list")
	public CommonResult<IPage<LogErrorVo>> list(@ApiIgnore @RequestParam Map<String, Object> logError, Query query) {
