...
import com.pgh.kaleidoscope.core.tool.support.Try;
import com.pgh.kaleidoscope.core.tool.utils.ClassUtil;
import com.pgh.kaleidoscope.core.tool.utils.ConvertUtil;
import com.pgh.kaleidoscope.core.tool.utils.ReflectUtil;
...
@Slf4j
@AllArgsConstructor
public class KaleidoscopeConverter implements Converter {
	...
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = KaleidoscopeConverter.getTypeDescriptor(targetClazz, (String) fieldName);
