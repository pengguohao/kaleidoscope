package com.pgh.kaleidoscope.core.tool.utils;

import lombok.experimental.UtilityClass;
import com.pgh.kaleidoscope.core.tool.convert.KaleidoscopeConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = KaleidoscopeConversionService.getInstance();
