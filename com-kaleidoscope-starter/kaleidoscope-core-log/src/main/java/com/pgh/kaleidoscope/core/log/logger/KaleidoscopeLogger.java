 ...
 */
package com.pgh.kaleidoscope.core.log.logger;

import com.pgh.kaleidoscope.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class KaleidoscopeLogger implements InitializingBean {
