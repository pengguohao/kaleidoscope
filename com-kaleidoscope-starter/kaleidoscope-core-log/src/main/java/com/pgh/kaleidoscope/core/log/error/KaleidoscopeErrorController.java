 ...
 * @author Chill
 */
public class KaleidoscopeErrorController extends BasicErrorController {

	public KaleidoscopeErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
