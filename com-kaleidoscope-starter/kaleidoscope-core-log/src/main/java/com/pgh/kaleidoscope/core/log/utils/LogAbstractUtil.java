...
package com.pgh.kaleidoscope.core.log.utils;

import com.pgh.kaleidoscope.core.log.model.LogAbstract;
...
public class LogAbstractUtil {
	 ...
	 *
	 * @param logAbstract     日志基础类
	 * @param kaleidoscopeProperties 配置信息
	 * @param serverInfo      服务信息
	 */
	public static void addOtherInfoToLog(LogAbstract logAbstract, KaleidoscopeProperties kaleidoscopeProperties, ServerInfo serverInfo) {
		logAbstract.setServiceId(kaleidoscopeProperties.getName());
		logAbstract.setServerHost(serverInfo.getHostName());
		logAbstract.setServerIp(serverInfo.getIpWithPort());
		logAbstract.setEnv(kaleidoscopeProperties.getEnv());
