 ...
 */
package com.pgh.kaleidoscope.core.oss;

import com.pgh.kaleidoscope.core.tool.utils.CollectionUtil;
...
import com.pgh.kaleidoscope.core.oss.props.OssProperties;
import com.pgh.kaleidoscope.core.oss.rule.OssRule;
...
public class QiniuTemplate {
	...
	@SneakyThrows
	public KaleidoscopeFile putFile(MultipartFile file) {
		return putFile(ossProperties.getBucketName(), file.getOriginalFilename(), file);
	}


	@SneakyThrows
	public KaleidoscopeFile putFile(String fileName, MultipartFile file) {
		return putFile(ossProperties.getBucketName(), fileName, file);
	}


	@SneakyThrows
	public KaleidoscopeFile putFile(String bucketName, String fileName, MultipartFile file) {
		return putFile(bucketName, fileName, file);
	}


	@SneakyThrows
	public KaleidoscopeFile putFile(String fileName, InputStream stream) {
		return putFile(ossProperties.getBucketName(), fileName, stream);
	}


	@SneakyThrows
	public KaleidoscopeFile putFile(String bucketName, String fileName, InputStream stream) {
		return put(bucketName, stream, fileName, false);
	}

	@SneakyThrows
	public KaleidoscopeFile put(String bucketName, InputStream stream, String key, boolean cover) {
		...
		KaleidoscopeFile file = new KaleidoscopeFile();
		file.setName(key);
