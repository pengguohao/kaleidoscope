...
import com.pgh.kaleidoscope.core.tool.utils.ImageUtil;
 ...
 */
@Slf4j
public class KaleidoscopeFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{KaleidoscopeFileUtil.formatUrl(uploadPath.toString()), KaleidoscopeFileUtil.formatUrl(virtualPath.toString())};
	}
