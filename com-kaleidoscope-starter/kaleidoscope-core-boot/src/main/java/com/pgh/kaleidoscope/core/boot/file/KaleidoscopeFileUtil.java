 ...
 * @author Chill
 */
public class KaleidoscopeFileUtil {
	 ...
	 * @return BladeFile
	 */
	public static KaleidoscopeFile getFile(MultipartFile file) {
	 ...
	 * @return BladeFile
	 */
	public static KaleidoscopeFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static KaleidoscopeFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new KaleidoscopeFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return BladeFile
	 */
	public static List<KaleidoscopeFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BladeFile
	 */
	public static List<KaleidoscopeFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static List<KaleidoscopeFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<KaleidoscopeFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new KaleidoscopeFile(file, dir, path, virtualPath));
		}
		return list;
	}
