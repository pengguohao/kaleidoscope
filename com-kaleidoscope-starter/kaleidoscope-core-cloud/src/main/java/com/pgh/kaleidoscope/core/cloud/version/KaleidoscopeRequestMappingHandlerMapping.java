 ...
 */
package com.pgh.kaleidoscope.core.cloud.version;
 ...
 * @author L.cm
 */
public class KaleidoscopeRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
	...
	private RequestMappingInfo getApiVersionMappingInfo(Method method, Class<?> handlerType) {
		...
		// 如果url版本不存在
		if (nonUrlVersion) {
			String vsersionMediaTypes = new KaleidoscopeMediaType(apiVersion.value()).toString();
