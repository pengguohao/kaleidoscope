 ...
 */
package com.pgh.kaleidoscope.core.cloud.feign;

import com.pgh.kaleidoscope.core.tool.utils.StringPool;
import com.pgh.kaleidoscope.core.tool.utils.StringUtil;
import feign.MethodMetadata;
import com.pgh.kaleidoscope.core.cloud.annotation.ApiVersion;
import com.pgh.kaleidoscope.core.cloud.annotation.UrlVersion;
import com.pgh.kaleidoscope.core.cloud.version.KaleidoscopeMediaType;
 ...
 * @author L.cm
 */
public class KaleidoscopeSpringMvcContract extends SpringMvcContract {

	public KaleidoscopeSpringMvcContract(List<AnnotatedParameterProcessor> annotatedParameterProcessors, ConversionService conversionService) {
	...
	protected void processAnnotationOnMethod(MethodMetadata data, Annotation methodAnnotation, Method method) {
		if (RequestMapping.class.isInstance(methodAnnotation) || methodAnnotation.annotationType().isAnnotationPresent(RequestMapping.class)) {
			...
			if (apiVersion != null && StringUtil.isNotBlank(apiVersion.value())) {
				KaleidoscopeMediaType KaleidoscopeMediaType = new KaleidoscopeMediaType(apiVersion.value());
				data.template().header(HttpHeaders.ACCEPT, KaleidoscopeMediaType.toString());
			}
		}
	}
