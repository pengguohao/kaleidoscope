 ...
 */
@AllArgsConstructor
public class KaleidoscopeHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	@Nullable
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		Callable<T> wrapCallable = new KaleidoscopeHttpHeadersCallable<>(callable, accountGetter, properties);
		return existingConcurrencyStrategy != null
