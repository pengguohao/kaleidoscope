...
@Slf4j
@AllArgsConstructor
public class KaleidoscopeFeignFallback<T> implements MethodInterceptor {
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
		...
		if (CommonResult.class != returnType) {
			return null;
		}
		// 非 FeignException
		if (!(cause instanceof FeignException)) {
			return CommonResult.fail(ResultCode.INTERNAL_SERVER_ERROR, errorMessage);
		}
		...
		if (resultNode.has(code)) {
			return JsonUtil.getInstance().convertValue(resultNode, CommonResult.class);
		}
		return CommonResult.fail(resultNode.toString());
	}
	...
	public boolean equals(Object o) {
		...
		KaleidoscopeFeignFallback<?> that = (KaleidoscopeFeignFallback<?>) o;
