...
import com.pgh.kaleidoscope.core.cloud.feign.KaleidoscopeFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class KaleidoscopeFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return KaleidoscopeFeignAutoConfiguration.class;
	}
