...
import com.pgh.kaleidoscope.core.cloud.feign.KaleidoscopeFallbackFactory;
...
public class KaleidoscopeHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		KaleidoscopeFallbackFactory kaleidoscopeFallbackFactory = new KaleidoscopeFallbackFactory(target);
		return (T) builder.target(target, kaleidoscopeFallbackFactory);
	}
